...
L["Enables or disables the minimap button."] = "Enables or disables the minimap button."
...
L["Toggles the display of raids that have have no progression on any shown characters."] = "Toggles the display of raids that have have no progression on any shown characters."
